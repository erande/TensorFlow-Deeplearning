...
print(tf.sort(a, direction='DESCENDING'))  # numpy=array([4, 3, 2, 1, 0])
...
# target = tf.broadcast_to(tf.constant([2, 0]), [3, 2])  # numpy=array([[2, 0], [2, 0], [2, 0]]
# topk = tf.transpose(tf.math.top_k(prob, 3).indices, [1, 0])  # numpy=array([[2, 1], [1, 0], [0, 2]]
# top1: [2, 0], [2, 1] => 1/2=50%
# top2: [2, 0], [2, 1] => 1/2=50%  + [2, 0], [1, 0] => 1/2=50% = 100%
# top2: [2, 0], [2, 1] => 1/2=50%  + [2, 0], [1, 0] => 1/2=50% + [2, 0], [0, 2] => 0/2=0 = 100%
...
print(res)  # [0.5, 1.0, 1.0], 与上述手动计算结果相同
